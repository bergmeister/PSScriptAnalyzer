...
Describe "GlobalSuppression" {
    ...
    Context "Error Case" {
        It "Raises Error for file not found" {
            ...
            $Error[0].FullyQualifiedErrorId | Should -Match "SettingsFileNotFound,Microsoft.PowerShell.ScriptAnalyzer.Commands.InvokeScriptAnalyzerCommand"
        }
        ...
        It "Raises Error for file with no hash table" {
            ...
            $invokeWithError.Count | Should -Be 0
            $Error[0].FullyQualifiedErrorId | Should -Match "SettingsFileHasNoHashTable,Microsoft.PowerShell.ScriptAnalyzer.Commands.InvokeScriptAnalyzerCommand"
        }
        ...
        It "Raises Error for wrong profile" {
            ...
            $invokeWithError.Count | Should -Be 0
            $Error[0].FullyQualifiedErrorId | Should -Match "WrongSettingsKey,Microsoft.PowerShell.ScriptAnalyzer.Commands.InvokeScriptAnalyzerCommand"
        }
    }
}